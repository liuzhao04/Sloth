...
import com.sloth.comm.excel.user.IExcelWriter;
/**
 * 大型Excel导入工具类
 * @author yWX366685
 *@version 1.0, 2016年9月11日
 */
public class BigExcelWriter implements IExcelWriter
{
    private SXSSFWorkbook wb;// 创建一个webbook对象，对应excel表
    ...
    {
        wb = new SXSSFWorkbook(10000); // 内存中只保留10000行数据
    ...
    {
        BigExcelWriter eWriter = new BigExcelWriter();
